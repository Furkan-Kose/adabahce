export default function WhatsAppButton() {
  return (
    <a
      href="https://wa.me/905391219195"
      target="_blank"
      rel="noopener noreferrer"
      aria-label="WhatsApp ile iletişime geçin"
      className="fixed bottom-6 right-6 z-40 w-14 h-14 rounded-full flex items-center justify-center bg-[#25D366] hover:bg-[#20BA5A] text-white shadow-lg hover:shadow-xl hover:scale-105 transition-all"
    >
      <svg
        viewBox="0 0 24 24"
        fill="currentColor"
